  ...
  return (
    <section className="flex flex-col items-center text-center min-h-screen bg-[#FDF9F5] px-6 pt-0 -mt-8 relative">
      ...
      <div className="flex flex-col md:flex-row items-center gap-4 mt-10">
        <button className=" bg-[#B494F9] text-[#0A0F0D] px-6 py-1.5 rounded-full font-[Hanken Grotesk] text-sm md:text-base hover:bg-[#5862E9] transition-all duration-500 shadow-md">
